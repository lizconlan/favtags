...
package :passenger, :provides => :appserver do
  ...
  gem "passenger" do
    ...
    [%Q(LoadModule passenger_module /usr/local/lib/ruby/gems/1.8/gems/passenger-#{version}/ext/apache2/mod_passenger.so),
    %Q(PassengerRoot /usr/local/lib/ruby/gems/1.8/gems/passenger-#{version}),
